...
public class VertretungsPlanMethoden {
    ...
    static String[][] replacements = {{"KU", "Kunst"},{"D", "Deutsch"},{"M", "Math"},{"E5", "Englisch"},{"S6", "Spanisch"},{"GE", "Geschichte"},{"Sw", "Sozialwissenschaften"},{"If", "Informatik"},{"Pa", "Pädagogik"},{"BI", "Biologie"},{"Ek", "Erdkunde"},{"PH", "Physik"},{"Er","ev. Religion"}, {"Ek", "kath. Religion"}};
